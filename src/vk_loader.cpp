...
std::optional<std::shared_ptr<LoadedGLTF>> loadGltf(VulkanEngine* engine, std::string_view filePath)
{
    ...
    for (fastgltf::Sampler& sampler : gltf.samplers) {
        ...
        sampl.minFilter = extract_filter(sampler.magFilter.value_or(fastgltf::Filter::Nearest));
   ...
   // load all textures
    ...
    if (!gltf.materials.empty()) {
        ...
        int data_index = 0;
        sceneMaterialConstants = (GLTFMetallic_Roughness::MaterialConstants*)file.materialDataBuffer.info.pMappedData;
