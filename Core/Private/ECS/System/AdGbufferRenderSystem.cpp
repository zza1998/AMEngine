...
namespace ade {
    ...
    void AdGbufferRenderSystem::OnInit(AdVKRenderPass *renderPass) {
        ...
        mPipeline->SetCullingMode(VK_CULL_MODE_BACK_BIT); // cull front
    ...
    void AdGbufferRenderSystem::OnRender(VkCommandBuffer cmdBuffer, AdRenderTarget *renderTarget) {
    ...
    void AdGbufferRenderSystem::ReCreateMaterialDescPool(uint32_t materialCount) {
        AdVKDevice *device = GetDevice();
    ...
    void AdGbufferRenderSystem::UpdateMaterialResourceDescSet(VkDescriptorSet descSet, AdSkyBoxComponent *skyBoxComp) {
        AdVKDevice *device = GetDevice();
    ...
    void AdGbufferRenderSystem::UpdateFrameUboDescSet(AdRenderTarget *renderTarget) {
